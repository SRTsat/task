        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight" role="banner" aria-label="Main heading">
              {sectionData.title || (
                <>
                  Streamline Your <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Team's Workflow</span> with SADA - Daily Task
                </>
              )}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              {((usePage().props as any).isSaas) && (
                <Link
                  ...
                  aria-label="Start free trial - Register for SADA - Daily Task"
                >
              ...
              <Link
                ...
                aria-label="Login to existing SADA - Daily Task account"
              >
                <Play size={18} />
          ...
          <div className="relative">
            {heroImage ? (
              <div className="relative">
                <img 
                  src={heroImage} 
                  alt="SADA - Daily Task Dashboard Preview" 
                  ...
                  <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-semibold text-gray-900">{t('SADA - Daily Task Dashboard')}</span>
                      </div>
