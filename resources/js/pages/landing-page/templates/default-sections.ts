export const defaultLandingPageSections = {
  sections: [
    ...
    {
      key: 'hero',
      title: 'SADA Daily Task - Project Management & Team Collaboration',
    ...
    // },
    {
      ...
      story_content: 'Founded by a team of project management enthusiasts and technology experts, Daily Task was born from the frustration of scattered tools and inefficient workflows.',
      image: '',
    ...
    },
    {
      ...
      members: [
        { name: 'Sarah Johnson', role: 'CEO & Founder', bio: 'Former tech executive with 15+ years experience.', image: '', linkedin: '#', email: 'sarah@Daily Task.com' }
      ]
    },
    {
      key: 'testimonials',
      ...
      testimonials: [
        { name: 'Alex Thompson', role: 'Project Manager', company: 'TechCorp Inc.', content: 'Daily Task has revolutionized how we manage projects and collaborate as a team.', rating: 5 }
      ]
    },
    {
      key: 'plans',
    ...
    },
    {
      ...
      faqs: [
        { question: 'How does Daily Task work?', answer: 'Daily Task allows you to create projects, assign tasks, track progress, and collaborate with your team efficiently.' }
      ]
    },
    {
      key: 'newsletter',
      title: 'Stay Updated with Daily Task',
    ...
    },
    {
      key: 'contact',
      title: 'Get in Touch',
      subtitle: 'Have questions about Daily Task? We\'d love to hear from you.',
