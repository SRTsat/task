...
class LandingPageSetting extends Model
{
    ...
    {
        $settings = self::first();
        $app_name = config('is_saas', false) == true ? 'SADA Daily Task - SaaS' : 'SADA Daily Task';            
        ...
        if (!$settings) {
            ...
            $defaultConfig = [
                'sections' => [
                    ...
                    [
                        ...
                        'screenshots_list' => [
                            [
                                'src' => '/storage/media/5/q-SADA Daily Task-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/6/r-SADA Daily Task-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/7/s-SADA Daily Task-saas-pic.png',
                                'alt' => 'Task Management',
                            ...
                            [
                                'src' => '/storage/media/16/ab-SADA Daily Task-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/21/ag-SADA Daily Task-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/11/w-SADA Daily Task-saas-pic.png',
                    ...
                    [
                        ...
                        'members' => [
                            ['name' => 'Sarah Johnson', 'role' => 'CEO & Founder', 'bio' => 'Former tech executive with 15+ years experience.', 'image' => '', 'linkedin' => '#', 'email' => 'sarah@SADA Daily Task.com'],
                            ['name' => 'Michael Chen', 'role' => 'CTO', 'bio' => 'Software architect with expertise in cloud solutions.', 'image' => '', 'linkedin' => '#', 'email' => 'michael@SADA Daily Task.com'],
                            ['name' => 'Emily Rodriguez', 'role' => 'Head of Product', 'bio' => 'Product strategist focused on user experience.', 'image' => '', 'linkedin' => '#', 'email' => 'emily@SADA Daily Task.com'],
                            ['name' => 'David Kim', 'role' => 'Lead Developer', 'bio' => 'Full-stack developer specializing in scalable applications.', 'image' => '', 'linkedin' => '#', 'email' => 'david@SADA Daily Task.com'],
                        ]
            ...
            $settings = self::create([
                ...
                'contact_email' => 'info@SADA Daily Task.com',
